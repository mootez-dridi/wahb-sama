...
const routes: Routes = [
    ...
    {path:'demandeFourniture',loadChildren:()=>import('./views/user/demande-fourniture/demande-fourniture.module').then(m=>m.DemandeFournitureModule)},
    {path:'demandeFournitureAccepter',loadChildren:()=>import('./views/user/demande-fourniture-accepter/demande-fourniture-accepter.module').then(m=>m.DemandeFournitureAccepterModule)},
    {path:'demandeFournitureApprouver',loadChildren:()=>import('./views/user/demande-fourniture-approuver/demande-fourniture-approuver.module').then(m=>m.DemandeFournitureApprouverModule)},
    {path:'demandeFournitureRef',loadChildren:()=>import('./views/user/demande-fourniture-ref/demande-fourniture-ref.module').then(m=>m.DemandeFournitureRefModule)},
    {path:'demandeFournitureAtt',loadChildren:()=>import('./views/user/demande-fourniture-att/demande-fourniture-att.module').then(m=>m.DemandeFournitureAttModule)},
    {path:'adddemandeFourniture',loadChildren:()=>import('./views/user/add-demande-fourniture/add-demande-fourniture.module').then(m=>m.AddDemandeFournitureModule)},
